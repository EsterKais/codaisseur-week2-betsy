...
manny = Product.create(name: "Manny", amount: 16, race: "Holstein Friesian", description: "Super delicious on a burger! Nom..nom..", price: 150, color: "White", age: 5, gender: "Female", edible: true, country_origin: "Asia", user: laura, photos: [photo7, photo8])
klara = Product.create(name: "Klara", amount: 1, race: "Gelbvieh", description: "Moo's really loud, so we cannot sleep very well!", price: 450, color: "Brown", age: 7, gender: "Female", edible: true, country_origin: "Asia", user: ester, photos: [photo9])
